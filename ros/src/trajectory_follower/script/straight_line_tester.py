...
class control_tester:
	...
	def trajectory_generator(self):
		...
		for i in range(1, 500, 1):
			...
			point.path_point.point.x = 50.0 / \
				500 * i * math.cos(yaw) + origin_x
			point.path_point.point.y = 50.0 / \
				500 * i * math.sin(yaw) + origin_y
			point.path_point.theta = yaw
			point.v = 1.5
			self.path.trajectory_points.append(point)
